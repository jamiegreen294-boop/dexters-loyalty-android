...
for(const f of ['pos-pc-v3-addon.js','pos-pc-scanner.js','pos-pc-loyalty-test.js','pos-pc-category-home.js','pos-order-management.js','pos-pc-manager.js','pos-pc-table-payments.js','pos-sunday-roast.js','pos-pc-phone-orders.js']){
...
for(const required of ['pos-pc-v3-addon.js','pos-pc-scanner.js','pos-pc-loyalty-test.js','pos-pc-category-home.js','pos-order-management.js','pos-pc-manager.js','pos-pc-table-payments.js','pos-sunday-roast.js','pos-pc-phone-orders.js','dexters-table-order-pc-test','uber-table-service-pc-test-api']){
...
console.log('PASS GitHub Pages PC POS build: category cards, scanner, loyalty, held/table/QR accounts, Square, refunds, manager, part-pay/split-bill, Sunday Roast payment flags, caller-aware phone orders and safe test routes present');
