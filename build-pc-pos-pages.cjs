...
console.log('PASS GitHub Pages PC POS build: staff PIN/session security, scanner pairing, core POS, offline retry/dedupe, scheduled promotions, recipe ingredient deduction, supplier purchasing/receiving, expiry/stocktake, Money Owed statements, kitchen busy mode/capacity, close-day workflow, customer phone, loyalty, phone, WhatsApp, customer 360, split/merge, ingredient stock, digital receipts/invoices, customer display, manager and security audit controls present');
