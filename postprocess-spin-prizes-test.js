...
.dx-spin-logo-wrap{position:absolute;left:50%;top:50%;transform:translate(-50%,-50%);width:50%;max-width:190px;min-width:130px;height:auto;aspect-ratio:2/1;border-radius:999px;display:grid;place-items:center;background:#0b0f14;border:4px solid var(--yellow);box-shadow:0 5px 18px #000b;z-index:30;pointer-events:none;overflow:hidden}
.dx-spin-logo-wrap img{width:76%;height:76%;object-fit:contain;display:block}
...
console.log('Added customer Spin to Win prize guide with full-cover Dexter centre badge and catering layout guard');
