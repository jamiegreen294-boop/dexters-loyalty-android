...
function addLogo(){
  ...
  var wheel=candidates.find(function(el){var r=el.getBoundingClientRect();return r.width>160&&r.height>160})||candidates[0];
  if(!wheel)return;
...
setTimeout(add,300);setTimeout(add,900);setTimeout(add,1800);
...
console.log('Added customer Spin to Win prize guide and centre logo');
