(() => {
  ...
  function applyTheme(){const d=new Date(),m=d.getMonth()+1,day=d.getDate();let theme='standard';if(m===1&&day>=20&&day<=26)theme='burns';else if(m===1||(m===2&&day<=15))theme='valentine';else if(m===6)theme='pride';else if(m===9||m===10)theme='halloween';else if(m===11&&day>=23&&day<=30)theme='standrew';else if(m===11||m===12)theme='christmas';document.documentElement.dataset.theme=theme;if($('themeBadge'))$('themeBadge').textContent=({pride:'Pride Month',burns:'Burns Night',standrew:"St Andrew\'s",halloween:'Halloween',christmas:'Christmas',valentine:"Valentine\'s",standard:'Standard'}[theme]||theme);}
