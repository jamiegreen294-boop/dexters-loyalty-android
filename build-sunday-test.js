...
for(const file of ['core.js','api.js','customer.js','admin.js','style.css'])fs.copyFileSync('sunday/'+file,'dist/sunday/'+file);
...
// The Sunday KDS test now uses the real isolated Sunday test API and the same authenticated KDS session.
