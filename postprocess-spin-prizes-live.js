...
function add(){
  ...
  card.innerHTML='<h2>🎁 What you could win</h2><p class="muted">Spin each day for a chance to win one of these Dexter’s rewards:</p><div class="dx-spin-prize-list"><div class="dx-spin-prize">💷 £2 off<small>Any order over £10</small></div><div class="dx-spin-prize">☕🍰 Free coffee + cake</div><div class="dx-spin-prize">🥪 Free toastie</div><div class="dx-spin-prize">🍽️ Free meal<small>A randomly selected eligible meal</small></div></div><div class="dx-spin-prize" style="margin-top:12px"><strong>Prize win rules</strong><small>• Prizes expire 30 days after the date you win them.<br>• Prizes can only be claimed through the Dexter’s app when placing a collection order.<br>• Prizes cannot be redeemed in store or by staff on the terminal.<br>• Tapping Claim reserves the prize for your order; it is only marked used when that order is submitted.<br>• If you leave the order before submitting, the prize stays available until it is used or expires.<br>• One use only. No cash alternative.</small></div><p class="tiny muted" style="margin-top:10px">When you win, the app will show the prize and its use-by date.</p>';
