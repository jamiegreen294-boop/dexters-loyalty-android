...
console.log('PC POS v3 built with safe test APIs, offline retry/dedupe, automatic scheduled promotions, customer phone linking, order management, Square, manager controls, part-pay tables, Sunday Roast, phone, WhatsApp, customer 360, ingredient stock, split/merge, supplier tools, digital receipts, customer display and staff security audit');
