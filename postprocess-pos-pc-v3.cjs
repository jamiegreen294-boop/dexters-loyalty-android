...
console.log('PC POS v3 built with safe test APIs, offline retry/dedupe, category cards, order management, Square, manager controls, part-pay table accounts, Sunday Roast, caller-aware phone orders, WhatsApp inbox, customer 360, ingredient stock, split/merge, supplier tools, digital receipts, customer display and staff security audit');
