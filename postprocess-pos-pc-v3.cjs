...
console.log('PC POS v3 built with safe test APIs, staff PIN/session security, offline retry/dedupe, scheduled promotions, recipe ingredient deduction, supplier purchasing/receiving, expiry/stocktake, Money Owed statements, kitchen busy mode/capacity, customer phone linking, order management, Square, manager controls, part-pay tables, Sunday Roast, phone, WhatsApp, customer 360, ingredient stock, split/merge, digital receipts, customer display and staff security audit');
