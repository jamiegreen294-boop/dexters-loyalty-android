...
for(const f of ['pos-pc-v3-addon.js','pos-pc-scanner.js','pos-pc-loyalty-test.js','pos-pc-category-home.js'])fs.copyFileSync('web/'+f,'dist/'+f);
console.log('PC POS v3 built from actual Android tablet UI with safe test APIs and category-card home');
