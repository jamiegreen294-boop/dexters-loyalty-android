...
for(const f of ['pos-pc-v3-addon.js','pos-pc-scanner.js','pos-pc-loyalty-test.js','pos-pc-category-home.js','pos-order-management.js','pos-pc-manager.js','pos-pc-table-payments.js','pos-sunday-roast.js'])fs.copyFileSync('web/'+f,'dist/'+f);
console.log('PC POS v3 built with safe test APIs, category cards, order management, Square, manager controls, part-pay table accounts and Sunday Roast payment flags');
