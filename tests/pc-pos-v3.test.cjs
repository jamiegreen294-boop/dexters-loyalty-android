...
'/pos-pc-v3-addon.js','/pos-pc-scanner.js','/pos-pc-loyalty-test.js',
'qrcode@1.5.4'
];
...
console.log('PASS PC POS v3: tablet UI, table/QR, auth, cash/card, money owed, Sunday Roast, scanner and loyalty test layers present; live table API blocked');
