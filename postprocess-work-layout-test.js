...
:root{--work-bg:#f7f7f5;--work-card:#fff;--work-ink:#151515;--work-muted:#6f6f6f;--work-accent:#111;--work-soft:#efefec}
body:has(#homePage:not(.hidden)){background:var(--work-bg)!important;color:var(--work-ink)!important}
...
body:has(#homePage:not(.hidden)) #homePage>.card{margin:14px 0!important;display:block!important;background:var(--work-card)!important;color:var(--work-ink)!important;border:0!important;border-radius:18px!important;box-shadow:0 6px 18px rgba(0,0,0,.05)!important;padding:16px!important}
body:has(#homePage:not(.hidden)) #homePage>.card:first-child{background:transparent!important;box-shadow:none!important;padding:4px 0!important}
...
body:has(#homePage:not(.hidden)) #homePage .btn{background:var(--work-accent)!important;color:#fff!important;border-radius:16px!important}
body:has(#homePage:not(.hidden)) #collectionOrderLiveCard{border-radius:22px!important;padding:20px!important;box-shadow:0 8px 24px rgba(0,0,0,.06)!important}
#workQuickActions{display:grid;grid-template-columns:1fr 1fr;gap:12px;margin:14px 0}
.work-action{border:0;text-align:left;background:var(--work-card);color:var(--work-ink);border-radius:18px;padding:16px;box-shadow:0 6px 18px rgba(0,0,0,.05);font:inherit;cursor:pointer;text-decoration:none}
.work-action .wi{font-size:24px}.work-action .wt{font-weight:900;margin-top:7px}.work-action .wd{font-size:12px;color:var(--work-muted);margin-top:4px}.work-badge{display:inline-block;background:#fff3cd;color:#8b6500;font-size:11px;font-weight:800;padding:5px 8px;border-radius:999px;margin-top:7px}
...
console.log('Locked Work home layout, seasonal palette and quick actions applied');
