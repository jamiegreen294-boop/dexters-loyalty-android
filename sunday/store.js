...
function initial(){return{config:{enabled:true,date:C.nextSunday(),slots:['12:00','12:15','12:30','12:45','13:00'],stock:{chicken:30,beef:20,kids_chicken:20,kids_beef:15},override:'auto'},orders:[]}}
function normalize(s){const base=initial();s.config.stock={...base.config.stock,...(s.config.stock||{})};for(const k of Object.keys(C.meals))if(!Number.isInteger(s.config.stock[k]))s.config.stock[k]=base.config.stock[k];return s}
